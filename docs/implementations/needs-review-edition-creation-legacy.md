# Legacy seven-step edition plan

This is the plan as it stood before the Audible mapping investigation. It is retained for historical decisions and completed-step details. The [current plan](needs-review-edition-creation.md) supersedes its unmerged steps and audiobook ASIN assumptions.
